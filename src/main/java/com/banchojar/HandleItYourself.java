...
public class HandleItYourself {
    public static void handleOsuDirect(Context ctx) throws IOException {
        ...
        //         OsuMainHandler.sanitize((String) diff.get("DiffName")),
        ...
        //         OsuMainHandler.sanitize((String) set.get("Artist")),
        //         OsuMainHandler.sanitize((String) set.get("Title")),
        //         set.get("Creator"),
